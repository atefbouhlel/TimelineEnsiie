...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      this.choices = 0;
      return this.results_none_found = this.options.no_results_text || "Aucun résultat";
    };
        ...
        if (this.is_multiple) {
          ...
          $.ajax({
            ...
            success:function(result){
              var rubric=$.parseJSON(result);
              $('#rubric').removeAttr('disabled');
              for (var i = 0; i <rubric.length; i++) {
                $('#rubric').append('<option value="'+rubric[i].id+'">'+rubric[i].name+'</option>');
              }
