    ...
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                function init(){
				  ...
				  btFinish = $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("buttonFinish uibutton finir  ");
                  ...
                  $(btNext).click(function() {
                    if($('#event_title').val()=='' || $("#file_input").val()=="" || $("#datepick").val()==''){
                      ...
                      if(!$(this).hasClass('disabled')){
                         if($.isFunction(options.onFinish)) {
                          alert('cc');
                           ...
                           var frm = obj.children('form');
                           if(frm && frm.length){
                            $("#rubrics_tab").attr('value',rubrics);
                             frm.submit();
                           }                         
                         }                      
                      }
