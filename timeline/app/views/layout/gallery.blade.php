 ...
 <div class="onecolumn" >
                        ...
                        <div id="buttom_top">
                            <ul class="uibutton-group">
                                <li><a class="uibutton icon add pop_box"   href="modalalbum.html"  >Nouveau Album</a></li>
                                <li><div id="uploadButtondisable"></div><a  class="uibutton disable icon secure pop_box"   id="uploadAlbum">Ajouter photo dans un album</a>
                                </li>
                            </ul>
                        </div>
                        </div><!-- End header -->	
                                         ...
                                         <div class="album load" id="{{$tab['rub']->id}}">
                                              <div class="preview">
                                                ...
                                                @foreach ($tab['pub'] as $p)
                                                 ...
                                                 $i++
                                                 ?>
                                                 <img width="130" id="photo{{$i}}" class="stackphotos" src="{{$p->url}}" alt="Thumbnail" />
                                                   
                                                @endforeach
                                              <div style="clear:both"></div>
                                              </div>
                                              <div class="title top20">
                                                <a title="télécharger cet album" href="{{URL::to('telechargement',['id' => $tab['rub']->id])}}"><i class="fa fa-download" aria-hidden="true"></i></a>
                                                <a title="supprimer cet album" href=""><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                {{$tab['rub']->name}} </div>
                     ...
                     <div class="screen-msg"><span class="icon"><img src="images/icon/dialog.png" alt="dialog"/></span>Cliquer sur un album pour afficher les photos</div>
